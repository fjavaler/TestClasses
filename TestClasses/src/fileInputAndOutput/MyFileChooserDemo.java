...
public class MyFileChooserDemo
{
	...
	private void initialize()
	{
		...
		lbl.setBounds(10, 11, 76, 14);
		frame.getContentPane().add(lbl);

		txtFileName = new JTextField();
		txtFileName.setEditable(false);
		txtFileName.setBounds(98, 8, 326, 20);
		...
		mntmSave.addActionListener(new ActionListener()
		{
			public void actionPerformed(ActionEvent e)
			{
				if (!fileSaved)
				{
					fileName = JOptionPane.showInputDialog(frame, "Enter Filename...");
		...
		mntmSave.setIcon(
				new ImageIcon(MyFileChooserDemo.class.getResource("/javax/swing/plaf/metal/icons/ocean/floppy.gif")));
		mnFile.add(mntmSave);
